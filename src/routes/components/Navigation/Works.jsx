...
import BaguiosBestImg from '../../../assets/BBC1.jpg'
import POSImg from '../../../assets/POS1.png'
import HMSImg from '../../../assets/HMS1.png'
      ...
      <div className="works">
        <Card.Group doubling itemsPerRow={3} stackable>
          <Popup
            trigger={
              <Card>
              <Image className="works-img" src={BaguiosBestImg} wrapped ui={false} />
              <Card.Content>
          ...
          <Popup
            trigger={
              <Card>
              <Image className="works-img" src={POSImg} wrapped ui={false} />
              <Card.Content>
          ...
          <Popup
            trigger={
              <Card>
              <Image className="works-img" src={HMSImg} wrapped ui={false} />
              <Card.Content>
          ...
          <Popup
            trigger={
              <Card>
              <Image className="works-img" src={PortfolioImg} wrapped ui={false} />
              <Card.Content>
